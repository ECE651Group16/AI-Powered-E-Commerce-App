...
class OrderAdmin(admin.ModelAdmin):
    ...
    search_fields = ['id__istartswith', 'customer__first_name__istartswith', 'customer__last_name__istartswith']

@admin.register(models.Collection) # admin.site.register(models.Collection)
