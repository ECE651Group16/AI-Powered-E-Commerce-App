    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price', models.DecimalField(decimal_places=2, max_digits=6, validators=[django.core.validators.MinValueValidator(0.009, message='Ensure this value is greater than or equal to 0.01.')])),
                ('inventory', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
                ('total_sells', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rating', models.DecimalField(choices=[(Decimal('1'), '1'), (Decimal('1.5'), '1.5'), (Decimal('2'), '2'), (Decimal('2.5'), '2.5'), (Decimal('3'), '3'), (Decimal('3.5'), '3.5'), (Decimal('4'), '4'), (Decimal('4.5'), '4.5'), (Decimal('5'), '5')], decimal_places=1, max_digits=2)),
