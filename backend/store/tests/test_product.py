    ...
    def _upload_image(product_id, image_path):
        ...
        with open(image_path, "rb") as img:
            ...
            return api_client.post(
                f"/store/products/{product_id}/images/", data, format="multipart"
            )
...
class TestUploadImage:
    ...
    def test_image_upload_invalid_file_for_product(
        self, upload_image, authenticate, create_product
    ):
        authenticate(is_superuser=True)
        collection = Collection.objects.create(title="Test Collection")
        product_data = {
    ...
    def test_image_upload_staff_permission(
        self, upload_image, authenticate, create_product
    ):
    ...
    def test_if_product_exists_returns_200(self, api_client):
        ...
        assert response.data == {
            ...
            "price_with_tax": round(
                product.unit_price * Decimal(1.1), 2
